 ...
 * </copyright>
 */
package com.smartisanos.voice.expandscreen.trio.bintrie;

import com.smartisanos.voice.expandscreen.trio.bintrie.util.ArrayTool;
import com.smartisanos.voice.expandscreen.trio.datrie.ITrie;
import com.smartisanos.voice.expandscreen.trio.io.ByteArray;
import com.smartisanos.voice.expandscreen.trio.util.IOUtil;
import com.smartisanos.voice.expandscreen.trio.util.TextUtility;
 ...
 * @author hankcs
 */
public class BinTrie<V> extends Node<V> implements ITrie<V>, Externalizable {
...
//        child = new BaseNode[65535 + 1];    // (int)Character.MAX_VALUE
    ...
    public void put(String key, V value) {
        ...
        for (int i = 0; i < chars.length - 1; ++i) {
            // 除了最后一个字外，都是继续
            BaseNode child = branch.getChild(chars[i]);
    ...
    public boolean load(String path, V[] value) {
        ...
        int childNum = byteArray.nextInt();
