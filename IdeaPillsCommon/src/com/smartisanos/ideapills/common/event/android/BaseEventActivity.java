package com.smartisanos.ideapills.common.event.android;
...
import com.smartisanos.ideapills.common.event.ISubscriber;
import com.smartisanos.ideapills.common.event.impl.LocalEventDispatcher;
import com.smartisanos.ideapills.common.event.impl.LocalEventSubscriber;
...
public class BaseEventActivity extends Activity implements IDispatcher, ISubscriber {
    ...
    @Override public final void subscribe(Object subscriber) {
    ...
    @Override public final void unsubscribe(Object subscriber) {
        if (null == mRealDispatcher || null == subscriber) {
            return;
        }
    ...
    @Override public final void postAsync(Event event) {
    ...
    @Override public final void postAsync(String action) {
        if (null == mRealDispatcher) {
            return;
        }
    ...
    @Override public final void post(Event event) {
        if (null == mRealDispatcher) {
            return;
        }
    ...
    @Override public final void post(String action) {
        if (null == mRealDispatcher) {
            return;
        }
    ...
    @Override public String[] getInterestedEvents() {
        //override if needed
        return null;
    }
