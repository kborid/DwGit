...
public class ImRecentViewManager extends ImBaseViewManager {
    public ImRecentViewManager(Context context, View view, boolean mode) {
    ...
    protected View getView() {
        View view = null;
        if (mRootView != null) {
            ViewStub contentStup = (ViewStub) mRootView.findViewById(R.id.recent_contact_container_stub);
            if (contentStup != null && contentStup.getParent() != null) {
                view = contentStup.inflate();
            } else {
                view = mRootView.findViewById(R.id.recent_contact_container);
            }
            ...
            gridView.setNumColumns(mDragMode ? ImBaseViewManager.DRAG_MODE_COLUMN_RECENT : ImBaseViewManager.DEFAULT_COLUMN_RECENT);
            ...
            loadData(ImBaseViewManager.TYPE_CONTENT_RECENT);
            mListView = gridView;
        }
        return view;
    }
