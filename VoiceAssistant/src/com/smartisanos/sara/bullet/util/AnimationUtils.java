...
public class AnimationUtils {
    ...
    public static void showViewWithAlphaAndScale(final View view , boolean isAnim) {
        if (view != null && view.getVisibility() != View.VISIBLE) {
            view.clearAnimation();
            AnimationSet set = new AnimationSet(true);
            AlphaAnimation alphaAnim = new AlphaAnimation(0.0f, 1.0f);
            ScaleAnimation scaleAnim = new ScaleAnimation(0.5f, 1f, 0.5f, 1f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
            set.addAnimation(alphaAnim);
    ...
    public static void hideViewWithAlphaAndScale(final View view, boolean isAnim) {
        if (view != null && view.getVisibility() == View.VISIBLE) {
            view.clearAnimation();
            view.setVisibility(View.GONE);
            AnimationSet set = new AnimationSet(true);
            AlphaAnimation alphaAnim = new AlphaAnimation(1.0f, 0.0f);
            ScaleAnimation scaleAnim = new ScaleAnimation(1f, 0.5f, 1f, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f, Animation.RELATIVE_TO_SELF, 0.5f);
            set.addAnimation(alphaAnim);
            set.addAnimation(scaleAnim);
            set.setDuration(ANIM_DURATION);
            if (isAnim) {
