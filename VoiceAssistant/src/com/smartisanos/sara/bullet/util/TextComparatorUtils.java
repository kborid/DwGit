...
public class TextComparatorUtils {
...
//        }
    ...
    public static String getLeadingChar(String s) {
    ...
    public static String getLeadingUp(String s) {
        if (TextUtils.isEmpty(s)) {
            return null;
        }
        ...
        if (leading == null) {
            leading = PinYinUtils.getLeadingUpper(c);
        }

        return leading;
    }

    public static String getLeadingLo(String s) {
        if (TextUtils.isEmpty(s)) {
            return null;
        }
        ...
        if (leading == null) {
            leading = PinYinUtils.getLeadingLower(c);
        }
