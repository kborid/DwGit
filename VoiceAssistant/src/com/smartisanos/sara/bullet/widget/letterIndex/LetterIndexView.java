package com.smartisanos.sara.bullet.widget.letterIndex;
...
public class LetterIndexView extends View {
    ...
    private void parseAttr(Context paramContext, AttributeSet paramAttributeSet) {
        ...
        mLetterHeight = array.getDimensionPixelSize(R.styleable.LetterIndexView_letterHeight, -1);
    ...
    protected void onDraw(Canvas canvas) {
        ...
        if(letterLength > 0) {
            float letterH = (getHeight() - height - mLetterMarginBottom) / letterLength;
    ...
    private void onHit(float offset) {
        ...
        if (hit && listener != null) {
            ...
            int letterH = (getHeight() - height - mLetterMarginBottom) / length;
            for(int i = 0; i < length; i++) {
