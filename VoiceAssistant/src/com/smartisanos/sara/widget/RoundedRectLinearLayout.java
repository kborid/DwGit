...
public class RoundedRectLinearLayout extends LinearLayout {
    ...
    public void setRadiusMargin(int left, int top, int right, int bottom) {
        mRadiusMarginTop = top;
        mRadiusMarginLeft = left;
        mRadiusMargeinRight = right;
        mRadiusMargeinBottom = bottom;
        requestLayout();
    }
