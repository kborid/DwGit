...
/**
 * A {@link ListAdapter} which wraps a {@link HeadersAdapter} and automatically handles wrapping the
 * result of {@link HeadersAdapter#getView(int, android.view.View, android.view.ViewGroup)} and
 * {@link HeadersAdapter#getHeaderView(int, android.view.View, android.view.ViewGroup)}
 * appropriately.
 * 
 * @author Jake Wharton (jakewharton@gmail.com)
 */
final class HeadersAdapterWrapper extends BaseAdapter {
    ...
    HeadersAdapterWrapper(Context context,
    ...
    public WrapperView getView(int position, View convertView, ViewGroup parent) {
        ...
        // [workaround] if we delete contacts as the same time importing, some item may not recovery
        // after edit.
        // if (delegate instanceof BubbleListBaseAdapter && !((ContactsListBaseAdapter)
        // delegate).isEditMode()) {
        // wv.item.setTranslationX(0F);
